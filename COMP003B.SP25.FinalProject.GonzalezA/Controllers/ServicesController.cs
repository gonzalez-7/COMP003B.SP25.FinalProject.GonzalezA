...
namespace COMP003B.SP25.FinalProject.GonzalezA.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DateProvided,ServiceTypeId")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateProvided,ServiceTypeId")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
