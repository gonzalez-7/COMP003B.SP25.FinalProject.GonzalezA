...
namespace COMP003B.SP25.FinalProject.GonzalezA.Controllers
{
    public class BookingsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Bookings.Include(b => b.Car).Include(b => b.Customer).Include(b => b.Service);
        ...
        public async Task<IActionResult> Create([Bind("Id,BookingDate,CustomerId,CarId,ServiceId,Notes")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BookingDate,CustomerId,CarId,ServiceId,Notes")] Booking booking)
        {
            if (id != booking.Id)
            {
                return NotFound();
